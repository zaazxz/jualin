                ...
                <div className="w-full bg-[#0f171c]/80 backdrop-blur-xl rounded-2xl border border-[#1a272e] p-6 sm:p-10 shadow-[0_0_50px_rgba(0,0,0,0.3)] relative overflow-hidden group/card">
                    ...
                    <form className="space-y-6" onSubmit={submit}>
                        ...
                        <div className="flex items-center select-none group/check">
                            ...
                            <label htmlFor="remember" className="ml-3 text-sm text-slate-400 cursor-pointer group-hover/check:text-slate-300 transition-colors">
                    ...
                    <div className="mt-3 mb-3 relative">
                        ...
                        <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-[0.2em]">
                            <span className="bg-[#0f171c] px-4 text-slate-500">Atau masuk dengan</span>
                        </div>
                    </div>
